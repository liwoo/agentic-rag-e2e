...
```bash
python ico-decision-notice/scraper/scraper.py
```
...
The scraped data is stored in the `ico-decision-notice/data/` directory. Each decision notice is saved in its own numbered sub-folder (e.g., `case-1`, `case-2`, etc.).
